...
const PRODUCTS_DATA: Product[] = [
  // Electrical
  {
    ...
    image: 'https://placehold.co/600x400/e2e8f0/1e293b?text=Heavy+Duty+Alternator'
  },
  {
    id: 'e2',
    category: 'Electrical Products',
    ...
    <section id="products" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h4 className="text-sip-red font-bold uppercase tracking-widest text-sm mb-2">Our Catalog</h4>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Premium Product Selection</h2>
          <p className="text-gray-600">
            Browse our comprehensive inventory of heavy equipment parts and consumables.
          </p>
        </div>
          ...
          {filteredProducts.map((product) => (
            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col">
                <div className="text-xs font-semibold text-gray-400 mb-2 uppercase tracking-wide">{product.code}</div>
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-500 mb-4 text-sm">Can't find what you're looking for?</p>
          <a 
            href="#footer"
