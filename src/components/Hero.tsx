  ...
  return (
    <section id="hero" className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url("https://placehold.co/1920x1080/1a1a1a/ffffff?text=Hero+Banner+Image")',
        }}
      >
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center md:text-left">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 bg-sip-red/20 border border-sip-red/30 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-sip-red font-semibold text-xs tracking-wider uppercase">Heavy Equipment Support Specialist</span>
          </div>
          ...
          <p className="text-gray-300 text-lg md:text-xl mb-8 leading-relaxed max-w-2xl">
            CV. Sumber Inti Prima delivers top-tier electrical components, hydraulic solutions, and custom parts to keep your heavy machinery running at peak performance.
          </p>
