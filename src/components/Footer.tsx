    ...
    <footer id="footer" className="bg-black text-white pt-20 pb-10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <div className="font-extrabold text-2xl italic mb-6">
              ...
              />
              <span className="text-sm block not-italic font-sans font-bold text-gray-400 mt-1">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-sip-red transition-colors"
              >
                <Instagram size={18} />
              </a>
              <a
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
          <p>
            &copy; {new Date().getFullYear()} CV. Sumber Inti Prima. All rights
            reserved.
          </p>
